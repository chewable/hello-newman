...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.read_count'
        db.add_column('blog_entry', 'read_count', orm['blog.entry:read_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Entry.read_count'
        db.delete_column('blog_entry', 'read_count')

...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'Entry.blog'
        db.create_table('blog_entry_blog', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entry', models.ForeignKey(orm.Entry, null=False)),
            ('blog', models.ForeignKey(orm.Blog, null=False))
        ))
        
        # Renaming column for field 'category'.
        db.rename_column('blog_entry', 'category_id', 'category')
        
    
    
    def backwards(self, orm):
        
        # Dropping ManyToManyField 'Entry.blog'
